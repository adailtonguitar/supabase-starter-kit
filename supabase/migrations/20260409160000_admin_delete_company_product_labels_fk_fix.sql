-- Fix FK product_labels_product_id_fkey when deleting demo companies.
-- Delete product_labels by product_id before deleting products.
...
BEGIN
  ...
  -- Company-scoped tables (best effort)
