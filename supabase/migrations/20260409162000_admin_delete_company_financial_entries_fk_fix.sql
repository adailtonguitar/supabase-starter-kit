-- Fix FK financial_entries_company_id_fkey when deleting companies.
...
DECLARE
  v_exists boolean;
  v_is_demo boolean;
  v_has_products_company_id boolean;
BEGIN
  ...
  v_has_products_company_id := EXISTS (
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='financial_entries' AND column_name='company_id') THEN
    EXECUTE 'DELETE FROM public.financial_entries WHERE company_id = $1' USING p_company_id;
  END IF;

  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='suppliers' AND column_name='company_id') THEN
    EXECUTE 'DELETE FROM public.suppliers WHERE company_id = $1' USING p_company_id;
  END IF;

  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='clients' AND column_name='company_id') THEN
    EXECUTE 'DELETE FROM public.clients WHERE company_id = $1' USING p_company_id;
  END IF;

  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='employees' AND column_name='company_id') THEN
    EXECUTE 'DELETE FROM public.employees WHERE company_id = $1' USING p_company_id;
  END IF;

  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='carriers' AND column_name='company_id') THEN
    EXECUTE 'DELETE FROM public.carriers WHERE company_id = $1' USING p_company_id;
  END IF;

  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='promotions' AND column_name='company_id') THEN
    EXECUTE 'DELETE FROM public.promotions WHERE company_id = $1' USING p_company_id;
  END IF;

  IF v_has_products_company_id AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='product_labels' AND column_name='product_id') THEN
    EXECUTE 'DELETE FROM public.product_labels WHERE product_id IN (SELECT id FROM public.products WHERE company_id = $1)'
      USING p_company_id;
  ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='product_labels' AND column_name='company_id') THEN
    EXECUTE 'DELETE FROM public.product_labels WHERE company_id = $1' USING p_company_id;
  END IF;
  ...
  IF v_has_products_company_id AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='price_history' AND column_name='product_id') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='sales' AND column_name='company_id') THEN
    EXECUTE 'DELETE FROM public.sales WHERE company_id = $1' USING p_company_id;
  END IF;
  IF v_has_products_company_id THEN
