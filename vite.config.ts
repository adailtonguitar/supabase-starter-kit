...
export default defineConfig(({ mode }) => ({
  define: {
    // Always point to the production Supabase instance (external).
    // This ensures both preview and published builds use the same backend
    // where the real user accounts and data live.
