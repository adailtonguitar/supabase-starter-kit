...
import { Wifi, WifiOff, Keyboard, X, Search, Monitor, FileText, User, PackageX, PackagePlus, Package, Maximize, Minimize, Banknote, CreditCard, QrCode, Smartphone, Ticket, MoreHorizontal, Clock as ClockIcon, Trash2, Hash, Percent, AlertTriangle, Plus, Wallet, Pause, Play, RotateCcw, MessageSquare, Tv, Printer } from "lucide-react";
  ...
  const handleCreditSaleConfirmed = async (client: CreditClient, mode: "fiado" | "parcelado" | "sinal", installments: number, downPaymentAmount?: number) => {
    ...
    try {
      ...
      setFiadoReceipt({
        ...
        cpf: client.cpf,
        total: savedTotal,
        items: savedItems.map(i => ({ name: i.name, qty: i.quantity, price: i.price })),
