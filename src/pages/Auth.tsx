    ...
    try {
      ...
      try {
        ...
        if (result.products === -1) {
          ...
          toast.success(`Dados demo criados: ${result.products} produtos · ${result.clients} clientes · ${result.sales} vendas · ${result.suppliers} fornecedores · ${result.expenses} despesas`);
        }
      } catch (seedErr: any) {
