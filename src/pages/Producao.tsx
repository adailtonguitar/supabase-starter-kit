...
export default function Producao() {
  ...
  const saveRecipeMut = useMutation({
    mutationFn: async () => {
      ...
      const { data: recipe, error } = await supabase.from("recipes").insert({ company_id: companyId, name: recipeName.trim(), output_quantity: outputQty, output_unit: outputUnit }).select().single();
