  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      <div className="px-6 pt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Card><CardContent className="flex items-center gap-4 p-4"><div className="w-10 h-10 rounded-xl bg-amber-500/10 flex items-center justify-center"><User className="w-5 h-5 text-amber-500" /></div><div><p className="text-xs text-muted-foreground">Clientes Devedores</p><p className="text-lg font-bold text-foreground">{debtorCount}</p></div></CardContent></Card>
