              ...
              <div className="flex items-start gap-2 p-3 rounded-lg bg-primary/10 text-primary text-xs">
                ...
                <div>
                  ...
                  <p className="mt-1 text-foreground/80">
                    ...
                    e uma cópia cifrada fica no seu navegador (IndexedDB) para contingência offline. A senha nunca é armazenada em texto claro no servidor
                    (apenas um hash bcrypt). Para máxima soberania, prefira certificado A3 (token físico) — a chave privada nunca sai do hardware.
                  </p>
                </div>
              </div>
            </>
