...
export function useCreateEmployee() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, variables) => {
      ...
      if (companyId) logAction({ companyId, userId: user?.id, action: "Funcionário criado", module: "funcionarios", details: (variables as Record<string, unknown>).name as string || null });
    },
